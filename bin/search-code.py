#!/usr/bin/env python3
"""search-code.py — Code repository and package search.

Usage:
    python3 wiki-code-search.py search <query> [--top N] [--type repos|packages|qa|all]
    python3 wiki-code-search.py info <package_name> [--registry npm|pypi]

Sources:
    - GitHub Search API (repos, code)
