#!/usr/bin/env python3
"""citation_graph.py — Citation graph building via snowballing.

Usage:
    python3 citation_graph.py forward <doi>              — Papers citing this one
    python3 citation_graph.py backward <doi>             — Papers this one references
    python3 citation_graph.py snowball <doi> [--depth 2] — Recursive snowball
    python3 citation_graph.py graph [--format json]      — Export citation graph
    python3 citation_graph.py stats                      — Citation DB statistics

Uses Semantic Scholar and OpenAlex APIs for citation data.
Stores results in .wiki/cache/citations.db.
"""
